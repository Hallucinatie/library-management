...
class Paper {
    ...
    static _convertToSnakeCase(paperData) {
        ...
        if (paperData.isPublic !== undefined) converted.is_public = paperData.isPublic;
        if (paperData.userId) converted.user_id = paperData.userId;
        if (paperData.publicationDate) converted.publication_date = paperData.publicationDate;
        if (paperData.downloadCount) converted.download_count = paperData.downloadCount;
